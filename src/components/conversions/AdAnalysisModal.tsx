      ...
      <div className="relative bg-[#1a1a2e] border border-gray-700/50 rounded-2xl w-full max-w-3xl max-h-[85vh] overflow-hidden shadow-2xl mx-4">
          ...
          {error && !loading && !loadingCreative && (
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <button
                ...
                className="mt-4 px-4 py-2 bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 rounded-lg text-sm transition-colors"
              >
                다시 시도
              </button>
            </div>
              ...
              <div className="prose prose-invert prose-sm max-w-none text-center">
                <ReactMarkdown
                  components={{
                    ...
                    h3: ({ children }) => <h3 className="text-base font-medium text-purple-300 mt-4 mb-2">{children}</h3>,
                    ...
                    blockquote: ({ children }) => (
                      <blockquote className="border-l-4 border-purple-500 pl-4 py-1 bg-purple-500/5 rounded-r-lg my-3">
                        {children}
                      </blockquote>
                    ),
                  }}
        ...
        {analysis && !loading && !loadingCreative && (
          <div className="px-6 py-3 border-t border-gray-700/50 flex justify-end gap-2">
            ...
            <button
              onClick={() => selectedCreative ? runAnalysisWithCreative(selectedCreative) : runAnalysis()}
              className="px-3 py-1.5 text-sm bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 rounded-lg transition-colors flex items-center gap-1.5"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
