  ...
  if (channels.length === 0) {
    return (
      <div className="p-12 text-center">
        ...
        <Link
          href="/ad-channels"
          className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-pink-500 to-blue-500 text-white font-medium rounded-xl hover:opacity-90 transition-opacity"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="p-6">
          ...
          <div className="border-l border-slate-700 flex flex-col">
            ...
            <div className="px-4 pb-3 flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-blue-400 border border-blue-400/50 rounded-lg hover:bg-blue-400/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
                {generatingCaption ? (
                  <>
      ...
      <div className="mt-6 flex justify-end gap-3">
        ...
        <button
          ...
          className="px-6 py-3 bg-gradient-to-r from-pink-500 to-blue-500 text-white font-medium rounded-xl hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
        >
          {publishing && (
